...
def data():
    ...
    df1=pd.read_excel(r'G:\Raj\PdfExtractor\Raj Chudasama\2022-12-22\ALDFWTP Guest Services\EXPECTED ARRIVALS 12-22-22.xlsx')

    df2=pd.read_excel(r'G:\Raj\PdfExtractor\Raj Chudasama\2022-12-21\ALDFWTP Guest Services\EXPECTED ARRIVALS 12-21-22.xlsx')


    df_concat = pd.merge(df1, df2, on='common_column_name', how='outer')

    print('jghkghjkghjkhk')
